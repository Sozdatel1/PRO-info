//  Эта функция проверяет залогин ли ты в кабинете разработчика, если да , показывает кабинет, если нет, то ведет на страницу входа. А такжн она выходит и стирает куки. ОН ПОДКЛЮЧАЕТСЯ К ФАЙЛУ КАБИНЕТА И ПРОВЕРЯЕТ НА УСЛОВИЯ ВЫШЕ.
